...
public class ItemRestController {
	...
	public String adicionarItem(@PathVariable("id") Long idProduto, int quatidade) {
	...
	public String atualizarItem(@PathVariable("id") Long idItem, @RequestParam(required = false) Long idProduto, @RequestParam(required = false) Integer quantidade) {
	...
	public String deletarProduto(@PathVariable Long idItem) {
	...
	public Optional<Item> buscarProduto(@PathVariable("id") Long idItem) {
